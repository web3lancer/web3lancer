export default function Head() {
  return (
    <>
      ...
      <meta name="description" content="Web3Lancer - The Premier Decentralized Freelancing Platform for Web3 Innovators and Professionals. Find projects, hire talent, and build the future of the decentralized web." />
      <meta name="keywords" content="web3, freelance, blockchain, decentralized, smart contracts, crypto, ethereum, xion, jobs, projects, developers, designers" />
      <meta name="author" content="Web3Lancer Team" />
      <meta name="theme-color" content="#1A202C" /> {/* Darker theme color for a modern feel */}
      <meta name="apple-mobile-web-app-capable" content="yes" />
      <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
      {/* Add more icons for different devices */}
