...
export const USER_BOOKMARKS_DATABASE_ID = process.env.NEXT_PUBLIC_APPWRITE_DATABASE_CONTENT_ID!;
...
export const PORTFOLIO_MEDIA_BUCKET_ID = process.env.NEXT_PUBLIC_APPWRITE_BUCKET_PROJECT_MEDIA_ID!; // Maps from PROJECT_MEDIA_ID
