...
// MESSAGE_ATTACHMENTS_BUCKET_ID is already defined above with '!'
...
// Example of a duplicated/outdated section (to be removed or refactored):
/*
// Databases
...
// ... and so on for other duplicated constants ...
*/
...
// New environment variables (these are also largely duplicates of the ones at the top with '!')
...
// export const NEXT_PUBLIC_APPWRITE_DATABASE_FINANCE_ID = process.env.NEXT_PUBLIC_APPWRITE_DATABASE_FINANCE_ID || ''; // Already defined
// ... and so on for other duplicated constants ...

// Storage Bucket IDs (duplicates)
...
export const NEXT_PUBLIC_APPWRITE_BUCKET_PORTFOLIO_MEDIA_ID = process.env.NEXT_PUBLIC_APPWRITE_BUCKET_PORTFOLIO_MEDIA_ID || '';
export const NEXT_PUBLIC_APPWRITE_BUCKET_POST_ATTACHMENTS_ID = process.env.NEXT_PUBLIC_APPWRITE_BUCKET_POST_ATTACHMENTS_ID || '';
