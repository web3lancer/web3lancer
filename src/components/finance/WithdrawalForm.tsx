    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <div className="mb-4 p-4 bg-blue-50 rounded-md">
          <p className="text-sm text-blue-700">
            Available balance: {formatCurrency(wallet.currency)}{wallet.balance.toFixed(wallet.type === 'crypto' ? 8 : 2)} {wallet.currency}
          </p>
        </div>
        ...
        <div>
          ...
          {!filteredPaymentMethods.length && (
            <p className="mt-2 text-sm text-red-600">
              No compatible payment methods available. Please add a payment method first.
            </p>
          )}
        </div>
      )}
      ...
      <div>
        ...
        <div className="mt-2 bg-gray-50 p-4 rounded-md">
          ...
          {/* Here you would add fees if applicable */}
      ...
      <div className="flex justify-end space-x-3">
        ...
        <button
          type="submit"
          disabled={isSubmitting || amount <= 0 || amount > wallet.balance || !paymentMethodId}
